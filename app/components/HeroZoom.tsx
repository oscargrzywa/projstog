    ...
    <div data-hero style={{ height: "calc(100vh + 600px)", background: "#060807" }}>
      <div style={{ position: "sticky", top: 0, height: "100vh", overflow: "hidden", background: "#060807" }}>
        ...
        <div ref={bgRef} style={{ position: "absolute", inset: "-8%", transformOrigin: "center", willChange: "transform" }}>
          <div style={{ position: "absolute", top: "5%", left: "-5%", width: 800, height: 800, borderRadius: "50%", background: "radial-gradient(circle,rgba(27,157,23,0.16) 0%,transparent 70%)", filter: "blur(80px)", animationName: "aurora-blob-1", animationDuration: "16s", animationTimingFunction: "ease-in-out", animationIterationCount: "infinite", willChange: "transform" }} />
          <div style={{ position: "absolute", top: "20%", right: "-5%", width: 700, height: 700, borderRadius: "50%", background: "radial-gradient(circle,rgba(52,225,46,0.09) 0%,transparent 70%)", filter: "blur(100px)", animationName: "aurora-blob-2", animationDuration: "20s", animationTimingFunction: "ease-in-out", animationIterationCount: "infinite", willChange: "transform" }} />
          <div style={{ position: "absolute", bottom: "-5%", left: "28%", width: 600, height: 600, borderRadius: "50%", background: "radial-gradient(circle,rgba(0,200,160,0.08) 0%,transparent 70%)", filter: "blur(90px)", animationName: "aurora-blob-3", animationDuration: "14s", animationTimingFunction: "ease-in-out", animationIterationCount: "infinite", willChange: "transform" }} />
        ...
        <div ref={contentRef} style={{ position: "absolute", inset: 0, zIndex: 4, display: "flex", alignItems: "center", paddingTop: 68, willChange: "transform, opacity", transformOrigin: "center 38%" }}>
          <div className="hero-inner" style={{ maxWidth: 1500, width: "100%", margin: "0 auto", padding: "0 48px" }}>
            ...
            <div className="hero-cta" style={{ display: "flex", alignItems: "center", gap: 28, flexWrap: "wrap" }}>
              ...
              <a href={`tel:${phone.replace(/\s/g, "")}`} className="hero-phone-link" aria-label={phone} style={{ display: "inline-flex", alignItems: "center", gap: 10, color: "#ECE7DD", textDecoration: "none", fontSize: 15, fontWeight: 600, letterSpacing: 0.2 }}>
